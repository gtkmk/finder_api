...
func (postForgotPasswordHandler *PostCreatePostHandler) Handle(context *gin.Context) {
...
func (postForgotPasswordHandler *PostCreatePostHandler) openTableConnection() {
