...
const (
	...
	ProposalMustBeIntoStatusApprovedToBeSetAsWaitingSignatureConst = "A proposta deve estar no status de Aprovada para ser atualizada para Aguardando Assinatura."
	ProposalMustBeInPreContractIssuedToBeSetAsFormalizedConst      = "A proposta deve estar no status de Pré-Contrato Emitido para ser atualizada para Formalizada."
	ProposalCannotBeUnapprovedConst                                = "A proposta não pode ser desaprovada."
	ProposalCannotBeDeformalizedConst                              = "A proposta não pode ser desformalizada."
	...
	ItWasNotPossibleConvertProprietyValueConst                     = "Não foi possível converter o valor da propriedade."
	ItWasNotPossibleConvertLoanValueConst                          = "Não foi não possível converter o valor do emprestimo."
	ItWasNotPossibleConvertFirstInstallmentValueConst              = "Não foi não possível converter o valor da primeira parcela."
	ProposalHasMandatoryInformationNotFilledInConst                = "A proposta tem informações obrigatórias não preenchidas. Inserir '%s'."
	...
	ItWasNotPossibleConvertMaximumInstallmentValueConst            = "Não foi possível converter o valor máximo por parcela."
